...
class Car(product:String, cantidad:Int, id_compra:Int, precio:Int) {
 ...
 fun cate1() {
  ...
  for (myString in categoria1) {
   println("Tu haz comprado este producto ${myString}")
  }
  println("con el precio total de 500 pesos")
  println("Por tu compra haz resibido una Promoción del 2% de descuento")
 ...
 fun cate2() {
  ...
  for (myString2 in categoria2) {
   println("Tu haz comprado este producto ${myString2}")
  }
  println("con el precio total de $3,500 pesos")
  println("Por tu compra haz resibido una Promoción del 7% de descuento")
 ...
 fun cate3() {
  ...
  for (myString3 in categoria3) {
   println("Tu haz comprado este producto ${myString3}")
  }
  println("con el precio total de $1,000 pesos")
  println("Por tu compra haz resibido una Promoción del 5% de descuento")
 ...
 fun cate4() {
  ...
  for (myString4 in categoria4) {
   println("Tu haz comprado este producto ${myString4}")

  }
  println("con el precio total de $15,000 pesos")
  println("Por tu compra haz resibido una Promoción del 15% de descuento")
 ...
 fun cate5() {
  ...
  var categoria5 = listOf("Hoya", "Sarten", "Platos", "Cubiertos")
  for (myString5 in categoria5) {
   println("Tu haz comprado este producto ${myString5}")
  }
 ...
 fun cate6() {
  ...
  for (myString6 in categoria6) {
   println("Tu haz comprado este producto ${myString6}")
  }
  println("con el precio total de $12,000 pesos")
  println("Por tu compra haz resibido una Promoción del 10% de descuento")
